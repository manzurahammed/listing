...
<div class="m-content">
	...
	<!--begin::Form-->
	{{Form::open(['url' => 'pages', 'method' => 'post','class'=>'m-form m-form--fit m-form--label-align-right m-form--group-seperator'])}}
		<div class="m-portlet__body">
			...
			<div class="form-group m-form__group row">
				...
				<div class="col-lg-4">
					{{Form::text('slug',old('slug'),array('class'=>'form-control m-input'))}}
				</div>
			</div>
			<div class="form-group m-form__group row">
			...
			<div class="form-group m-form__group row">
				...
				<div class="col-lg-4">
					{{Form::text('order',old('order'),array('class'=>'form-control number m-input'))}}
				</div>
			</div>
			<div class="form-group m-form__group row">
				<label class="col-lg-2 col-form-label">

<!-- Footer -->
<footer style="background: url('{{ asset("images/frontend/footer-bg.jpg") }}')" class="footer-bg">
                ...
                <div class="col-lg-2 order-lg-2">
                    <div class="apps-download">
                        <a href="#" class="app-download apple">
                            <img src="{{ asset('images/frontend/apple.png') }}" class="img-fluid" alt="">
                        </a>
                        <a href="#" class="app-download android">
                            <img src="{{ asset('images/frontend/android.png') }}" class="img-fluid" alt="">
                        </a>
                    </div>
                </div>
...
<script src="{{ asset('css/frontend/custom.js') }}"></script>
 ...
 <!-- leaflet -->
 <script src="{{ asset('css/frontend/leaflet/js/leaflet-src.js') }}"></script>
 <script src="{{ asset('css/frontend/leaflet/js/leaflet.markercluster-src.js') }}"></script>
 <script src="{{ asset('css/frontend/leaflet/js/dummylatlng.js') }}"></script>

 <script src="{{ asset('css/frontend/searchMap.js') }}"></script>

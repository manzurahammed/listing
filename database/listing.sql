...
-- Dumping data for table admin_paper_size.amenties: ~7 rows (approximately)
DELETE FROM `amenties`;
/*!40000 ALTER TABLE `amenties` DISABLE KEYS */;
INSERT INTO `amenties` (`id`, `name`, `icon_class`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'Free Wifi', 'fas fa-wifi', '2018-04-01 11:04:22', '2020-02-16 17:04:59', NULL),
	(2, 'Free Parking', 'fas fa-motorcycle', '2018-04-01 11:10:22', '2020-02-16 18:11:04', NULL),
	(3, 'Air Conditioned', 'fas fa-asterisk', '2018-04-01 19:56:49', '2020-02-16 17:16:54', NULL),
	(23, 'Online Ordering', 'far fa-closed-captioning', '2020-02-16 16:59:46', '2020-02-16 17:04:29', NULL),
	(24, 'Child Zone', 'fas fa-child', '2020-02-16 18:12:55', '2020-02-16 18:12:55', NULL),
	(25, 'Sport Zone', 'fas fa-puzzle-piece', '2020-02-16 18:12:55', '2020-02-16 18:12:55', NULL),
	(26, 'Music', 'fas fa-music', '2020-02-16 18:12:55', '2020-02-16 18:12:55', NULL);
...
-- Dumping data for table admin_paper_size.categories: ~5 rows (approximately)
DELETE FROM `categories`;
/*!40000 ALTER TABLE `categories` DISABLE KEYS */;
INSERT INTO `categories` (`id`, `name`, `slug`, `image`, `icon`, `description`, `show_nav`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'Hotel & Restuarant', 'hotel-and-restuarant', 'image1602858932.png', 'icon306809790.png', '<p>The dimensions of the A series paper sizes are defined by the ISO 216 international paper size standard. The A series was adopted in Europe in the 19th century, and is currently used all around the world, apart from in the USA and Canada. The most common paper size used in English speaking countries around the world is A4, which is 210mm x 297mm (8.27 inches x 11.7 inches). The largest sheet from the A series is the A0 size of paper. It has an area of 1m2, and the dimensions are 841mm x 1189mm. The A series uses an aspect ratio of 1:√2, and other sizes in the series are defined by folding the paper in half, parallel to its smaller sides. For example, cutting an A4 in half, will create an two A5 sheets, and so forth. Any size of brochure can be made using paper from the next larger size, for example A3 sheets are folded to make A4 brochures. The standard lengths and widths of the A series are rounded to the nearest millimetre.<br></p>', 1, '2018-04-01 11:04:22', '2020-10-06 18:01:07', NULL),
	(2, 'Beauty & Spa', 'beauty-and-spa', 'image1366735484.png', 'icon1420007087.png', '<p>The dimensions of the B series paper sizes are defined by the ISO 216 international paper size standard. The B series is not as common as the A series. It was created to provide paper sizes that were not included in the A series. The B series uses an aspect ratio of 1:√2. The area of the B series paper sheets is the geometric mean of the A series sheets. For example, B1 is between A0 and A1 in size. While the B series is less common in office use, it is more regularly used in other special situations, such as posters, books, envelopes and passports.<br></p>', 1, '2018-04-01 11:10:22', '2020-10-06 18:01:36', NULL),
	(3, 'Real Estate', 'real-estate', 'image931935267.png', 'icon1638352681.png', '<p>The dimensions of the C series sizes are defined by the ISO 269 paper size standard. The C series is most commonly used for envelopes. The area of C series paper is the geometric mean of the areas of the A and B series paper of the same number. For example, C4 has a bigger area than A4, but smaller area than B4. Therefore an A4 piece of paper will fit into a C4 envelope. The aspect ratio of C series envelopes is 1:√2, and this means that an A4 sheet of paper when folded in half, parallel to its smaller sides, will fit nicely into a C5 envelope. When it is folded twice, it will fit into a C6 envelope, and so on.<br></p>', 1, '2018-04-01 19:56:49', '2020-10-06 18:02:32', NULL),
	(4, 'Food & Hotel', 'food-and-hotel', 'image1712970466.png', 'icon443483733.png', '<p>Loose Sizes</p><p>Paper sizes in North America do not follow a logical system like the ISO standard does. They have their own system that they follow. This means that scaling the paper sizes is more difficult. The US Letter paper size is the most popular size used throughout the US. It is also commonly used in Chile and the Philippines.</p><p><br></p><p>ANSI</p><p>The American National Standards Institute (ANSI) adopted ANSI/ASME Y14.1, which defined a series of paper sizes in 1996, based on the standard 8.5 inches x 11 inches (216mm x 279mm) Letter size, which was named ‘ANSI A’. This series is fairly similar to the ISO standard, in that if you cut a sheet in half, you will product two sheets of the next smaller size. Ledger/Tabloid is known as ‘ANSI B’. The most common and widely used size is ANSI A, also known as ‘Letter’.</p><p><br></p><p>Architectural Sizes</p><p>The Architectural series (ARCH) is used by architects in North America, and they prefer to use this series instead of ANSI, because the aspect ratios are ratios of smaller whole numbers (4:3 and 3:2). The ARCH series of paper sizes is defined in the ANSI/ASME Y14.1 standard. The ARCH sizes are commonly used by architects for their large format drawings.</p>', 1, '2018-04-01 20:17:10', '2020-10-06 18:07:10', NULL),
	(5, 'Travel', 'travel', 'image1239755102.png', 'icon2065657282.png', '<p>There are three main types of envelopes used in the US and they do not correspond to the ISO standard of paper sizes. They are known as Commercial, Announcement and Catalog. Other less known styles of envelope are Baronial, Booklet and Square. To identify the difference between a ISO size and the US size, a hyphen is often inserted between the letter and number. For example, A2 becomes A-2.</p><p><br></p><p>Commercial envelopes, also referred to as Office envelopes, are most commonly used in business situations as they are suitable for automated franking and filling. They are long and thin, with an aspect ration of between 1:1.6 and 1:2.2. The most well known commercial envelope is No.10, as it is able to fit Letter size paper folded three times, or Legal size paper folded four times parallel to the shorter side.</p><p><br></p><p>Announcement envelopes, also known as A series envelopes, are used for greeting cards, invitations and photographs. Their aspect ratio ranges between 1:1.3 to 1:1.6, which makes them more of a square shape, rather than long and thin like the Commercial envelopes. The most popular announcement envelopes are Lady Grey (A2) and Diplomat (A9).</p><p><br></p><p>Catalog envelopes are most commonly used for catalogs, brochures, and are made with a center seam to make them more durable.Their aspect ratio ranges between 1:1.3 and 1:1.5, making them very similar shape to the announcement envelopes.</p>', 1, '2018-04-01 20:40:04', '2020-10-06 18:06:08', NULL);
...
-- Dumping data for table admin_paper_size.city: ~5 rows (approximately)
DELETE FROM `city`;
/*!40000 ALTER TABLE `city` DISABLE KEYS */;
INSERT INTO `city` (`id`, `name`, `slug`, `image`, `show_nav`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'Los Angeles', 'city-1', 'image1797572163.jpg', 1, '2018-04-01 11:04:22', '2020-09-19 16:07:54', NULL),
	(2, 'Chicago', 'city-2', 'image499187772.jpg', 1, '2018-04-01 11:10:22', '2020-09-19 16:08:22', NULL),
	(3, 'San Francisco', 'city-3', 'image815655542.jpg', 1, '2018-04-01 19:56:49', '2020-09-19 16:08:53', NULL),
	(23, 'California', 'city-4', 'image911231068.jpg', 1, '2020-02-16 16:59:46', '2020-09-19 16:09:21', NULL),
	(24, 'New York', 'city-5', 'image198187394.jpg', 1, '2020-02-16 18:11:55', '2020-09-19 16:09:35', NULL);
...
-- Dumping data for table admin_paper_size.listing: ~6 rows (approximately)
DELETE FROM `listing`;
/*!40000 ALTER TABLE `listing` DISABLE KEYS */;
INSERT INTO `listing` (`id`, `title`, `cat_id`, `email`, `phone`, `latitude`, `longitude`, `status`, `created_at`, `updated_at`, `deleted_at`, `website`, `city_id`, `description`, `video_url`, `social`, `validation_date`, `feature_image`, `gallery_image`, `created_by`, `update_by`) VALUES
	(1, 'BD Club', 1, 'manzur@gmail.com', 'asdasdasd', '40.715452', '-74.014391', '0', '2020-03-02 16:50:12', '2020-10-07 19:30:02', NULL, 'www.yourwebsite.com', 23, '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat.</p>\r\n<p>reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia</p>', 'https://www.youtube.com/watch?v=GHlC73XxlBs', '{"twitter": "test", "facebook": "test"}', '2020-10-14', 'feature_1849048209.jpg', '["/gallery_image/gallery_2100656552.jpg", "/gallery_image/gallery_1652021669.jpg", "/gallery_image/gallery_212296351.jpg"]', 2, 2),
	(2, 'Golden Restuarant', 1, 'example@domain.com', '+50 125 145601', '40.703783', '-74.008729', '0', '2020-03-14 16:21:25', '2020-03-14 16:21:25', NULL, 'www.yourwebsite.com', 2, '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat.</p>\r\n<p>reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia</p>', 'https://www.youtube.com/watch?v=GHlC73XxlBs', '{"facebook": "facebook.com", "linkedin": "linkedin"}', '2020-03-21', 'feature_1836979317.jpg', '["/gallery_image/gallery_1942763272.jpg", "/gallery_image/gallery_1995155656.jpg", "/gallery_image/gallery_1877570751.jpg"]', 2, 2),
	(3, 'Careup Spa Center', 2, 'example@domain.com', '+50 125 145601', '40.717452', '-74.000391', '0', '2020-03-14 16:41:36', '2020-03-14 16:41:36', NULL, 'www.yourwebsite.com', 1, '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat.</p>\r\n<p>reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia</p>', 'https://www.youtube.com/watch?v=GHlC73XxlBs', '{"twitter": "twitter.com", "facebook": "facebook.com"}', '2020-03-21', 'feature_544368581.jpg', '["/gallery_image/gallery_1937846742.jpg", "/gallery_image/gallery_667848977.jpg", "/gallery_image/gallery_2062557705.jpg"]', 2, 2),
	(4, 'Golden Restuarant', 1, 'example@domain.com', '+50 125 145601', '40.712369', '-73.9934027', '0', '2020-03-14 16:21:25', '2020-03-14 16:21:25', NULL, 'www.yourwebsite.com', 23, '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat.</p>\r\n<p>reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia</p>', 'https://www.youtube.com/watch?v=GHlC73XxlBs', '{"facebook": "facebook.com", "linkedin": "linkedin"}', '2020-03-21', 'feature_1836979317.jpg', '["/gallery_image/gallery_1942763272.jpg", "/gallery_image/gallery_1995155656.jpg", "/gallery_image/gallery_1877570751.jpg"]', 2, 2),
	(5, 'Careup Spa Center', 2, 'example@domain.com', '+50 125 145601', '40.723046', '-73.9969537', '0', '2020-03-14 16:41:36', '2020-03-14 16:41:36', NULL, 'www.yourwebsite.com', 24, '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat.</p>\r\n<p>reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia</p>', 'https://www.youtube.com/watch?v=GHlC73XxlBs', '{"twitter": "twitter.com", "facebook": "facebook.com"}', '2020-03-21', 'feature_544368581.jpg', '["/gallery_image/gallery_1937846742.jpg", "/gallery_image/gallery_667848977.jpg", "/gallery_image/gallery_2062557705.jpg"]', 2, 2),
	(6, 'Careup Spa Center', 2, 'example@domain.com', '+50 125 145601', '40.730244', '-74.0346157', '0', '2020-03-14 16:41:36', '2020-03-14 16:41:36', NULL, 'www.yourwebsite.com', 3, '<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat.</p>\r\n<p>reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia</p>', 'https://www.youtube.com/watch?v=GHlC73XxlBs', '{"twitter": "twitter.com", "facebook": "facebook.com"}', '2020-03-21', 'feature_544368581.jpg', '["/gallery_image/gallery_1937846742.jpg", "/gallery_image/gallery_667848977.jpg", "/gallery_image/gallery_2062557705.jpg"]', 2, 2);
...
-- Dumping data for table admin_paper_size.listing_amenities: ~16 rows (approximately)
DELETE FROM `listing_amenities`;
/*!40000 ALTER TABLE `listing_amenities` DISABLE KEYS */;
INSERT INTO `listing_amenities` (`id`, `listing_id`, `amenities_id`) VALUES
	(6, 2, 1),
	(7, 2, 2),
	(8, 2, 3),
	(9, 2, 23),
...
-- Dumping data for table admin_paper_size.listing_business_hour: ~21 rows (approximately)
DELETE FROM `listing_business_hour`;
/*!40000 ALTER TABLE `listing_business_hour` DISABLE KEYS */;
INSERT INTO `listing_business_hour` (`id`, `listing_id`, `day`, `start_time`, `end_time`, `close`) VALUES
	(23, 2, 'saturday', '9 : 48 PM', '9 : 48 PM', 1),
	(24, 2, 'sunday', '9 : 48 PM', '9 : 48 PM', 1),
	(25, 2, 'monday', '9 : 48 PM', '9 : 48 PM', 0),
	(26, 2, 'Tuesday', '9 : 48 PM', '9 : 48 PM', 0),
	(27, 2, 'wednesday', '9 : 48 PM', '9 : 48 PM', 0),
	(28, 2, 'thursday', '9 : 48 PM', '9 : 48 PM', 0),
	(29, 2, 'friday', '9 : 48 PM', '9 : 48 PM', 1),
	(30, 3, 'saturday', '10 : 28 PM', '10 : 28 PM', 0),
	(31, 3, 'sunday', '10 : 28 PM', '10 : 28 PM', 0),
	(32, 3, 'monday', '10 : 28 PM', '10 : 28 PM', 1),
	(33, 3, 'Tuesday', '10 : 28 PM', '10 : 28 PM', 0),
	(34, 3, 'wednesday', '10 : 28 PM', '10 : 28 PM', 1),
	(35, 3, 'thursday', '10 : 28 PM', '10 : 28 PM', 0),
	(36, 3, 'friday', '10 : 28 PM', '10 : 28 PM', 0),
	(37, 1, 'saturday', '1 : 28 AM', '1 : 28 AM', 0),
	(38, 1, 'sunday', '1 : 28 AM', '1 : 28 AM', 0),
	(39, 1, 'monday', '1 : 28 AM', '1 : 28 AM', 1),
	(40, 1, 'Tuesday', '1 : 28 AM', '1 : 28 AM', 0),
	(41, 1, 'wednesday', '1 : 28 AM', '1 : 28 AM', 0),
	(42, 1, 'thursday', '1 : 28 AM', '1 : 28 AM', 1),
	(43, 1, 'friday', '1 : 28 AM', '1 : 28 AM', 0);
...
INSERT INTO `review` (`id`, `user_id`, `listing_id`, `title`, `description`, `rating`) VALUES
	(1, 2, 1, 'sdfsdf', 'sdfsdf sdf', 1),
	(2, 2, 1, 'sdfsdf', 'sdfsdf sdf', 1),
	(3, 2, 1, 'asdasd', 'asdasdd', 1);
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `status`, `role`, `image`, `bio`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Ahammed', 'Ahammed@gmail.net', '$2y$10$/F2YZbWzeJTj6rZiz0TT5OpI.VxKEZEIQVLcXvSuA.Zl5t1I8Wuom', 1, 1, 'image25864172.jpg', 'adfs dfgsafsdg', 'tr5k8YOklFDTLLWMebLHca3HidZaNy8brQRdLvo3ql5LNEXbr9x6yWdAdgUM', '2018-02-24 16:29:11', '2020-09-29 16:35:14'),
	(2, 'Admin', 'manzur@gmail.com', '$2y$10$nXi7XX6MOS.khQxct84oLOGO.ELiOTHIRYg7nZV3MmuXlo0xgVjia', 1, 2, 'image156876548.jpg', 'lol sdfsdf', 'pxZh2ti1ioEDY1aBXLXjcw0STk7bYDExXSGrTmZU8F8w5TwPNhce8yq33Fc5', '2018-02-28 15:37:18', '2020-03-19 18:16:08'),
	(3, 'Manzur Ahammed Tipu', 'sfdsf@gmail.com', '$2y$10$cqJYJ6iDVZVMgY3/x2wE1OHyAvazsGITm9/Ze4sj.cIfwxUM6kmeO', 1, 2, 'image904746879.jpg', NULL, NULL, '2018-02-28 15:39:47', '2020-09-29 16:34:44'),
	(4, 'Arif', 'arif@yahoo.com', '$2y$10$XdOmO32A7bFHTXMPIGzQXuUnx4YMQsctw9Q3VbJ6AmjNtuL0P0mRG', 1, 2, 'image212119674.jpg', NULL, NULL, '2018-02-28 15:44:15', '2020-09-29 16:35:37');
